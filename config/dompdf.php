...
return [
    ...
    */
    ...
    // Resolve public_path dynamically for cPanel vs local deployment.
    // Prevents RuntimeException: Cannot resolve public path on cPanel where /public doesn't exist.
    'public_path' => is_dir('/home/sina4714/public_html/pklku.sinaumedia.my.id')
        ? '/home/sina4714/public_html/pklku.sinaumedia.my.id'
        : (is_dir(base_path('public')) ? base_path('public') : base_path()),
