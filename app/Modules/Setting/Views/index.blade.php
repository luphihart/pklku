                ...
                <div class="tab-content" id="settingsTabContent">
                    ...
                    <div class="tab-pane fade" id="attendance" role="tabpanel" aria-labelledby="attendance-tab">
                        <div class="alert alert-info py-2 px-3 mb-4 d-flex align-items-center gap-2" style="font-size: 13px;">
                            ...
                            <div>
                                Anda dapat mengatur <strong>Jam Kerja Reguler, Shift Pagi, Shift Siang, dan Shift Sore</strong> standar sekolah di bawah ini. Pengaturan ini dapat dipilih atau dikustomisasi per murid saat melakukan <strong>Plotting Penempatan</strong>.
                            </div>
                        </div>
