...
Route::middleware(['web', 'auth'])->group(function () {
    ...
    Route::post('/presensi/libur-shift', [PresensiController::class, 'markLiburShift'])->name('presensi.libur_shift');
    Route::post('/presensi/cancel-libur-shift', [PresensiController::class, 'cancelLiburShift'])->name('presensi.cancel_libur_shift');
