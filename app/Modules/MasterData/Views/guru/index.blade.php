                            ...
                            <tr>
                                ...
                                <td class="text-center pe-4">
                                    <div class="d-flex gap-1 justify-content-center">
                                        ...
                                        <form action="{{ route('guru.reset_password', $guru->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin mereset password guru ini menjadi default (guru123)?');" style="display: inline-block;">
                                            @csrf
                                            <button type="submit" class="btn btn-sm btn-outline-info p-1" title="Reset Password (guru123)">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
