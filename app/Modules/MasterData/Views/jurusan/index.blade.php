                                ...
                                <tr>
                                    ...
                                    <td class="text-center pe-4">
                                        <div class="d-flex gap-1 justify-content-center">
                                            ...
                                            <button class="btn btn-sm btn-outline-warning btn-action" data-bs-toggle="modal" data-bs-target="#editModal_{{ $j->id }}" title="Edit Jurusan" aria-label="Edit Jurusan {{ $j->nama }}">
                                            ...
                                            <form action="{{ route('jurusan.destroy', $j->id) }}" method="POST" id="deleteJurusanForm_{{ $j->id }}" style="display: inline-block;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn btn-sm btn-outline-danger btn-action" title="Hapus Jurusan" aria-label="Hapus Jurusan {{ $j->nama }}" onclick="window.confirmDelete('deleteJurusanForm_{{ $j->id }}', 'jurusan {{ addslashes($j->nama) }}')">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <tr>
                                    <td colspan="4" class="text-center py-4">
                                        <div class="empty-state py-4">
                                            ...
                                            <h6 class="empty-state-title">Belum Ada Data Jurusan</h6>
                                            <p class="empty-state-text">Gunakan form di sebelah kiri untuk menambahkan program keahlian / jurusan baru.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
