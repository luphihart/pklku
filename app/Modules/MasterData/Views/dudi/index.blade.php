                        ...
                        <tr>
                            ...
                            <td class="text-center pe-4">
                                <div class="d-flex gap-1 justify-content-center">
                                    <button class="btn btn-sm btn-outline-warning btn-action" data-bs-toggle="modal" data-bs-target="#editModal_{{ $dudi->id }}" title="Edit DUDI">
                                    ...
                                    <form action="{{ route('dudi.destroy', $dudi->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus mitra DUDI ini? Semua hubungan penempatan aktif di dalamnya akan ikut dihapus.');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-outline-danger btn-action" title="Hapus DUDI">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
