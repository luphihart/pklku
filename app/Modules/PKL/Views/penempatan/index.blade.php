        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0" style="color: var(--text-primary);">
                ...
                <tbody style="font-size: 13px;">
                    @forelse($placements as $p)
                        <tr>
                            ...
                            <td class="text-center pe-4">
                                <form action="{{ route('penempatan.destroy', $p->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin membatalkan/menghapus penempatan PKL murid ini?');">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center py-4 text-muted">Belum ada penempatan murid aktif saat ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
